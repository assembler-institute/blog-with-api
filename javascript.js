...
/*function modal() {
    ...
    /* document.getElementById("main-modal").appendChild(modalMain) */
...
fetch('http://localhost:3000/users')
    ...
    .then(data => {
       /*  data.forEach(el => {
            ...
            document.getElementById('userContent').appendChild(divUser);
        }); */
        pepe = data;
    });
